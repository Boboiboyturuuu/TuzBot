...
let handler = async (m, { conn, usedPrefix, command }) => {
    const randomQuote = pickRandom(global.senja);
    conn.sendMessage(m.chat, {
        video: fs.readFileSync('./images/senja.mp4'),
        mimetype: 'video/mp4',
        fileLength: 100,
        caption: randomQuote, // Menggunakan hasil dari pickRandom(global.senja)
        gifPlayback: true,
        gifAttribution: 5,
        contextInfo: {
...
conn.sendFile(m.chat, './images/senja.mp3', '', null, m, true, {
        type: 'audioMessage',
        ptt: true,
        fileLength: 88738,
    });
